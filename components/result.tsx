            ...
            >
                ...
                >
                    <motion.h1
                        ...
                        className="text-3xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-lime-400 to-emerald-600 tracking-tight mb-8"
                    >
                        {prediction}
                    </motion.h1>
